...
<teiCorpus>
    <teiHeader>
        <fileDesc>
            <titleStmt>
                <title>Digitised and Encoded copy of The Equity, Issue n.1 1973</title>
            </titleStmt>
            <publicationStmt>
                <authority>Transcribed from digital copy available at
                    http://collections.banq.qc.ca:8008/jrn03/equity/src/</authority>
            </publicationStmt>
            <sourceDesc>
                <biblFull>
                    <titleStmt>
                        <title>The Equity, January 3rd 1973</title>
                    </titleStmt>
                    <publicationStmt>
                        <publisher>Printed by Pontiac Printshop ltd
                            </publisher>
                        <distributor> Bibliotheque National du Quebec
                            </distributor>
    ...
    <TEI>
        <teiHeader>
            <fileDesc>
                ...
                <publicationStmt>
                    <authority>Transcribed by a student of Digital History at Carleton Univeristy
                        </authority>
                </publicationStmt>
                <sourceDesc>
                    <bibl>
